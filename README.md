...
pupil.enqueue(element: .init(name: "Kirill", mark: 4))
pupil.enqueue(element: .init(name: "Alex", mark: 5))
pupil.enqueue(element: .init(name: "Amir", mark: 5))
pupil.enqueue(element: .init(name: "Andrey", mark: 3))
pupil.enqueue(element: .init(name: "Viktor", mark: 4))
pupil.enqueue(element: .init(name: "Timofey", mark: 3))
pupil.enqueue(element: .init(name: "Olga", mark: 4))
pupil.enqueue(element: .init(name: "Svetlana", mark: 3))
